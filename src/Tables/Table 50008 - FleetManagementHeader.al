table 50008 "Fleet Management Header"
{
    ...
    fields
    {
        field(1; "No."; Code[20])
        {
            ...
            begin
                if "No." <> xRec."No." then begin
                    SalesSetup.Get;
                    NoSeriesMgt.TestManual(SalesSetup."Fleet Mgt Nos.");
                    "No. Series" := '';
                end;
            end;
        }
        ...
        field(483; "Customer No."; Code[20])
        {
            ...
            begin
                FA.reset;
                FA.SetRange("No.", Rec."Customer No.");
                if FA.FindFirst() then begin
                    "Member Name" := FA.Description;

                end else begin
                    Error('Member No. %1 does not exist', Rec."Customer No.");
                end;
            end;
    ...
    begin
        ...
        if "No." = '' then begin
            ...
            SalesSetup.TestField("Fleet Mgt Nos.");
            "No. Series" := SalesSetup."Fleet Mgt Nos.";
            if NoSeriesMgt.AreRelated(SalesSetup."Fleet Mgt Nos.", xRec."No. Series") then
