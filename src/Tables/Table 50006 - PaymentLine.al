/// <summary>
/// Table Payment Line (ID 52188423).
/// </summary>

table 50006 "Payment Line"
{
    ...
    fields
    {
        ...
        field(13; "Account No."; Code[20])
        {
            ...
            ELSE
            IF ("Account Type" = CONST(Vendor), Grouping = FILTER('')) Vendor
            ELSE
    ...
    begin
        ...
        if PHead.FindFirst then
            if (PHead.Status = PHead.Status::Posted) then
                Error('You cannot delete this record its already posted');
