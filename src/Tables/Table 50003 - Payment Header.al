/// <summary>
/// Table Payments Header (ID 50003).
/// </summary>
/// 
Table 50003 "Payments Header"
{
    fields
    {
        field(1; "No."; Code[20])
        ...
        field(28; "Paying Bank Account"; Code[20])
        {
            ...
            ELSE
            IF ("Payment Type" = FILTER(<> "Petty Cash"), "Paying Account Type" = CONST("Bank Account"), "Pay Mode" = CONST(EFT)) "Bank Account"."No." WHERE("Currency Code" = FIELD("Currency Code"));
        ...
        field(150; "Account Type"; Enum "Gen. Journal Account Type")
        {
        ...
        field(50009; "Vat Witheld Code"; Code[10])
        {
            CalcFormula = lookup("Payment Line"."VAT Withholding Code" where(No = field("No.")));
            FieldClass = FlowField;
        }
        field(50010; "Witholding Tax Code"; Code[20])
        {
            CalcFormula = lookup("Payment Line"."Withholding Tax Code" where(No = field("No.")));
            FieldClass = FlowField;
        }
        field(50011; "Pay BBF"; Option)
        {
            OptionMembers = "Pay All","Pay Funeral Expense","Pay Loans And Deposits";

        }
        field(50012; "Cheque Posted"; Boolean)
        {
        ...
        field(50013; "Loan Balance"; Decimal)
        {
            trigger OnValidate()
            begin
                Rec."Total Payment Amount BBF" := Rec."Loan Balance" + Rec."Funeral Expense" + Rec."Deposits Refund";
            end;
        }
        field(50014; "Funeral Expense"; Decimal)
        {
        }
        field(50015; "Deposits Refund"; Decimal)
        {
            trigger OnValidate()
            var
                PaymentRecHeader: Record "Payments Header";
            begin
                Rec."Total Payment Amount BBF" := Rec."Loan Balance" + Rec."Funeral Expense" + Rec."Deposits Refund";
            end;
        }
